...
protected:
    ...
    example_vm() noexcept
    {
        msg.sender = Z5000000000000000000000000000000000000005_address;
        msg.recipient = Zd00000000000000000000000000000000000000d_address;
    }
...
TEST_F(example_vm, call)
{
    ...
    EXPECT_EQ(host.recorded_calls[0].recipient, Z0000000000000000000000000000000000000003_address);
