...
struct zvmc_message
{
     ...
     * For ::ZVMC_DELEGATECALL, this may be different from the zvmc_message::code_address.
     *
     ...
     *
     * For ::ZVMC_DELEGATECALL this may be different from the zvmc_message::recipient.
 ...
 * in the ZVMC repository (https://github.com/rgeraldes24/zvmc).
 */
 ...
 * ZVM revision.
 *
 * The revision of the ZVM specification based on the Zond
